...
>
> سجل تاريخي لخطة النقل، وليس مواصفة تشغيل محدثة. قد تصف الجداول والترتيبات أدناه أهدافًا أو حالة وقت كتابة الوثيقة؛ اعتمد [المعمارية الحالية](./architecture.md) و[مصفوفة حالة compiler C](./compiler-c-acceptance-matrix.md) عند وصف التنفيذ اليوم.
