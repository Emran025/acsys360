...
واجهة التطبيق والشجرة واللوحات موجهة من اليمين إلى اليسار، بينما مساحة إدخال الشفرة نفسها تستخدم `TextDirection.ltr` و`TextAlign.left`. هذا القرار مقصود؛ فهو يحافظ على دلالة الأسهم وHome وEnd داخل نص مختلط من العربية والأرقام والعمليات، ولا يعني أن الواجهة العربية فقدت اتجاهها العام.
