...
واجهة التطبيق والشجرة واللوحات موجهة من اليمين إلى اليسار، بينما مساحة إدخال الشفرة تستخدم `TextDirection.ltr` مع `TextAlign.right`. فصل الاتجاه عن المحاذاة مقصود: LTR يحافظ على دلالة الأسهم وHome وEnd داخل نص مختلط من العربية والأرقام والعمليات، وright يضع السطر بصريًا في جهة الكتابة العربية دون عكس ترتيب المؤشر.
...
| RTL | اختبار اتجاه TextField، النص المختلط، الأسهم، Home/End، Enter، وموضع المؤشر |
