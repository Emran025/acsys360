...
| `LineNumberedEditor` | عرض مساحة الكود مع gutter وMinimap وTextField | ArabicCodeController، selection، diagnostics | محرر قابل للتحرير والتمرير | TextField للكود LTR داخل shell RTL لحماية الأسهم وHome/End |
