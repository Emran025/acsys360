...
و`خيط_رمزي`، مع الإدخال والإخراج والتشخيصات المرتبطة بمواقع TAC. تقبل قراءة النوع
`منطقي` القيمتين `صح` و`خطأ` كما تكتبان في اللغة. ينتج كل بناء Windows ملف تنفيذ باسم فريد يتضمن معرّف
