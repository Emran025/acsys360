...
Future<void> main(List<String> args) async {
  ...
  check(
    (valid.$2['threeAddressCode'] as List).any(
      (item) => (item as String).startsWith('PRINT '),
    ),
    'TAC print lowering is missing',
  );
  check(
    (valid.$2['assembly'] as String).contains(
      'generated by arabicc C from 3AC',
    ),
    'Assembly did not come from TAC',
  );
  check(
  ...
  check(
    reordered.$1 == 0 && reordered.$2['success'] == true,
