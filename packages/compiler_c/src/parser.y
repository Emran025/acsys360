...
full_if : TOK_IF '(' full_expr ')' TOK_THEN full_statement ';' {$$=calloc(1,sizeof(CAstNode));$$->kind=C_AST_IF;$$->data.conditional.condition=$3;c_ast_list_append(&$$->data.conditional.then_branch,$6);} | TOK_IF '(' full_expr ')' TOK_THEN full_statement ';' TOK_ELSE full_statement ';' {$$=calloc(1,sizeof(CAstNode));$$->kind=C_AST_IF;$$->data.conditional.condition=$3;c_ast_list_append(&$$->data.conditional.then_branch,$6);c_ast_list_append(&$$->data.conditional.else_branch,$9);} | TOK_IF '(' full_expr ')' TOK_THEN full_statement TOK_ELSE full_statement ';' {$$=calloc(1,sizeof(CAstNode));$$->kind=C_AST_IF;$$->data.conditional.condition=$3;c_ast_list_append(&$$->data.conditional.then_branch,$6);c_ast_list_append(&$$->data.conditional.else_branch,$8);} ;
